...
function CallToAction() {
  ...
  return (
    <div className="w-full min-h-screen flex flex-col justify-center items-center">
          ...
          <div>
            ...
            >
              <div className="pb-10">
                <label className="relative">
                  <input
                    type="text"
                    name="user_name"
                    className="w-[360px] md:w-[450px] h-[50px]  text-blue-500 dark:text-[#f15bff] border-2 border-[#5a53686f] rounded-xl bg-[transparent] p-[10px] outline-none focus:border-blue-700 dark:focus:border-[#f15bff] transtion duration-200"
                  />
              ...
              <div className="pb-10">
                <label className="relative my-20  ">
                  <input
                    type="email"
                    name="user_email"
                    className="mb-[20px] w-[360px] md:w-[450px] h-[50px] text-blue-500 dark:text-[#f15bff] border-2 border-[#5a53686f] rounded-xl bg-[transparent] p-[10px] outline-none focus:border-blue-700 dark:focus:border-[#f15bff] transtion duration-200"
                  />
              ...
              <div className="pb-10">
                <label className="relative my-20">
                  <textarea
                    ...
                    name="message"
                    className=" placeholder:text-2xl w-[360px] md:w-[450px] text-blue-500 dark:text-[#f15bff] placeholder:text-[#6361666c] placeholder:pl-10 mb-[20px]  h-[200px] border-2 border-[#5a53686f] rounded-xl bg-[transparent] p-[10px] outline-none focus:border-blue-700 dark:focus:border-[#f15bff] transtion duration-200"
                  />
                </label>
              </div>
              {messagesent ? (
              ...
              <button
                type="submit"
                value="Send"
                className="w-[360px] md:w-[150px] h-[50px] rounded-full shadow-xl text-white bg-blue-800 dark:bg-[#f15bffc9] transition-all  hover:bg-blue-600"
              >
                Send message
              </button>
            </form>
      ...
      <div className="w-full h-20 font-abc bg-blue-600 dark:bg-[#f15bffc9] text-white flex justify-center items-center">
