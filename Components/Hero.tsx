...
function Hero() {
  return (
    <div className="w-full h-screen md:mt-[80px] mb-[200px] md:mb-[0px] flex flex-col justify-center items-center ">
      ...
      >
        <AiFillGithub className="shadow-xl cursor-pointer hover:shadow-sm transition-[all 0.2s ease]  rounded-full text-6xl p-2 text-[#726fdb]" />
        <TiSocialLinkedin className="shadow-xl hover:shadow-sm cursor-pointer mt-3 rounded-full text-6xl p-2 text-[#5651E5]" />
        <TiSocialTwitter className="shadow-xl hover:shadow-sm cursor-pointer rounded-full text-6xl p-2 text-[#5651E5]" />
      </motion.div>
    </div>
  );
}
